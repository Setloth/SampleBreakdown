...
export const techniqueSections = [
  {
    ...
    studies: [
      ...
      },
      {
        ...
        producer: "Kanye West",
        writeup: [
          "Another example of a drum break, the same idea of taking an isolated instrumental percussive section and breaking it up and looping it to serve as the foundation for a new track.",
          "This time, Kanye West sampled The Temptation's 'What It Is', which also has some vocals chopped up in the back, giving it some extra character."
        ],
        samples: [
          {
            id: "corner-drums",
            ...
            inTitle: "What It Is - The Temptations",
            outTitle: "The Corner",
...

  {
    ...
    title: "Sample Flips",
    blurb:
      "Reorganizing a song into a brand new composition, aka flipping parts of the track around and playing or looping them in a different order.",
    studies: [
      {
        slug: "stop",
        title: "Stop",
        ...
        producer: null,
        writeup: [
          "Now we start getting into the real fun, instead of just using one song as the foundational piece to an ultimately bigger track, sample flipping reuses a song to make something entirely new.",
          "In this example we will see how J Dilla broke apart Dionne Warwick's 'You're Gonna Need Me', and created an entirely new beat.",
        ],
        samples: [
          {
            id: "stop-flip",
            ...
            inTitle: "You're Gonna Need Me - Dionne Warwick",
            outTitle: "Stop",
            ...
            markers: [
              ...
              { id: "m-1786741934968", time: 16.02, label: "Main Vocals" },
      ...
      },
      {
        ...
        writeup: [
          ...
          "In this example, a sample is flipped but then supported by many other samples to build out a brand new composition. ",
        ],
        samples: [
          {
            id: "sunshine-flip",
            ...
            inTitle: "Leave It All Behind Me - The Fuzz",
            outTitle: "Sunshine",
      ...
      },
      {
        ...
        producer: "9th Wonder",
        writeup: [
          "Another approach to sample flipping with producer 9th Wonder of Little Brother taking apart 'I Believe You' by Cleo Laine",
          "Often one part of the song is used as an intro and surrounding sections get chopped up and reorganized to create the beat. Look for the markers before the loop below: ",
        ],
        samples: [
          {
            ...
            inTitle: "I Believe You - Cleo Laine",
...

  {
    ...
    blurb:
      "Combining a drum break with one or more additional samples layered on top, multiple samples working together on top of each other to create new music.",
    studies: [
      {
        slug: "my-homie",
        title: "My Homie",
        ...
        writeup: [
          ...
          "On this beat, he took one sample - 'Way' by Clearlight, and used it as an intro. Then he took drums from 'Superfine from Behind Lady' by the Cleveland Wrecking Co. and added an instrumental section from 'Italian Slides' by Entrance to fill it up.",
        ],
        samples: [
          {
            id: "my-homie-intro",
